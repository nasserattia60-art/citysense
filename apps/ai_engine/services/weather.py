"""
Weather intelligence service using Open-Meteo API.

Provides detailed weather analysis for a location including:
- Temperature statistics
- Human comfort assessment
- Snow/freezing risk
- Weather risk analysis (wind, visibility, pressure)
...
def get_weather_intelligence(lat: float, lon: float) -> dict:
    """
    Fetch and analyze weather intelligence for a location.
    ...
    Returns:
        dict: Contains nested weather analysis:
            - location: coords and timezone
            - statistics: 14-day temperature stats
            - human_feeling_index: comfort assessment with color coding
            - snow_analysis: snowfall risk with color coding
            - weather_risk_engine: severe weather risk with color coding
